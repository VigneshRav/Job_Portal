...
const JobListing = () => {
  ...
  return (
    <section id="jobs">
      <div className="bg-green-100 mx-auto flex flex-col lg:flex-row gap-8 py-8 px-4 lg:px-8">
        {/* FILTER SIDEBAR */}
        <motion.div
          className="w-full lg:w-1/4 bg-white rounded-xl shadow-sm"
              ...
              <>
                ...
                <div className="mb-4">
                  ...
                  <div
                    ...
                    className={`pr-2 transition-all duration-300 overflow-y-auto ${
                      showAllLocations ? "max-h-[260px]" : "max-h-[170px]"
                    }`}
                  >
                    <ul className="space-y-3">
                      {[...JobLocations]
                        ...
                        .map((location, index) => (
                          <li key={index} className="flex items-center">
                            ...
                            <label
                              ...
                              className="ml-3 text-gray-700 cursor-pointer hover:text-primary"
                            >
                              {location}
                            </label>
                          </li>
                  ...
                  {JobLocations.length > 6 && (
                    <button
                      onClick={() => {
                        setShowAllLocations(!showAllLocations);

                        // Always scroll to top when collapsing
                        if (showAllLocations) {
                          const container =
